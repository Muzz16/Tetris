...
public class Board extends JPanel implements KeyListener {
	...
	public Board() {
		...
		try {
			bg = ImageIO.read(Board.class.getResourceAsStream("/Sprites/totoro.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		// new gameOver
		try {
			gO = ImageIO.read(Board.class.getResourceAsStream("/Sprites/game_over.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}

		try {
			frame2 = ImageIO.read(Board.class.getResourceAsStream("/Sprites/totoroFrames.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
